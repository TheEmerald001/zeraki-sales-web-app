...
* React Redux, redux persist -For state management and data persisting
  These were primarily chosen due to their robustness and feature support, coupled with my seasoned experience in their utilization, allowing for a clean and expedited development.
...
6. Use the credentials below to log in to app.
   ``` 
    ...
    ```
*Alternatively:*
A deployed version of this application can be found [here](https://dashboard-zeraki-sales.onrender.com/).
This is containerized using docker and deployed as an instance on Render. Utilize the credentials provided above to access the application.
___
